...
if(isset($_POST['login']))
{
  ...
  {
      $pwd=md5($pwd);
      $lg_qry=$conn->query("select * from adminregister1 where email='$email' and password='$pwd'");
      ...
      else
      {
        ?>
<script>
  alert("Check your Crendientials");
</script>
...
<html lang="en">
 ...
 <?php }?>
  ...
  <p>Create an Account <a href="adminregister.php">Register Here</a></p>
</form>
  </div>
</div>
			</div>
